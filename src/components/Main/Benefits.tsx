...
export const Benefits = () => {
  ...
  return (
    <div
      className="bg-white dark:bg-dark-brown text-black  pl-[1.6rem] font-firago pt-8 scroll-mt-[8.1rem] lg:pl-[6rem] xl:pl-[10rem] xl:pt-10"
      id="about"
    >
      ...
      <Swiper slidesPerView={"auto"} spaceBetween={0} className="ml-[-0.4rem] lg:ml-[-1rem] xl:ml-[-2.7rem]" loop={true} >
