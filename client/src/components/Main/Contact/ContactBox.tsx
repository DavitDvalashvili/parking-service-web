...
export const ContactBox = ({ variant }: contact) => {
    ...
    return (
        ...
        flex flex-col justify-between xl:w-[51.3rem] xl:h-[37rem] xl:px-[2rem] xl:py-[2.7rem] xl:text-[2rem] dark:bg-dark-darkBrown dark:text-white ${isPopup ? "bg-primary text-white" : ""
            } `}>
            <div>
                ...
                <div className="flex flex-col gap-[3.2rem]  leading-[2.2rem] font-normal">
                    <div className="flex gap-8 items-center ">
                        <img
                            ...
                            src={
                                darkMode || isPopup
                                    ? "/icons/contact/envelopeDark.svg"
                                    : "/icons/contact/envelopeLight.svg"
                            }
                            alt="envelope"
                        />
                    ...
                    <div className="flex gap-8 items-center ">
                        <img
                            ...
                            src={
                                darkMode || isPopup
                                    ? "/icons/contact/phoneDark.svg"
                                    : "/icons/contact/phoneLight.svg"
                            }
                            alt="phone"
                        />
                    ...
                    <div className="flex gap-8 items-center ">
                        <img
                            ...
                            src={
                                darkMode || isPopup
                                    ? "/icons/contact/pinDark.svg"
                                    : "/icons/contact/pinLight.svg"
