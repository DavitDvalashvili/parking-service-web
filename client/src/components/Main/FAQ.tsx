...
export const FAQ = () => {
  ...
  return (
    <div className="font-firago py-8 bg-white dark:bg-dark-brown lg:py-[8rem] xl:py-[7rem] lg:max-w-[96rem] xl:max-w-[122rem] lg:mx-auto ">
      <h3
        className="text-black text-[2rem] font-bold leading-[90%] text-center pb-8 font-feature dark:text-white lg:text-[2.4rem] lg:pb-[4.7rem]
      ...
      <div className="flex flex-col gap-[1rem] text-white dark:text-black lg:gap-[2rem]">
        {faqContent.faq.map((faq, index) => (
          ...
          >
            <div className="flex justify-between items-center  text-[1.4rem] lg:text-[2rem] xl:text-[2.6rem]">
              <div className="leading-[1.7rem] font-semibold lg:leading-[2.2rem] xl:leading-[2.8rem]">
                {faq.question}
              </div>
              <div
              ...
              >
                <img
                  src={`${activeQuestion !== index ? "/icons/processReview/plusLight.svg" : "/icons/processReview/minusLight.svg"}`}
                  alt="plus&minus"
                  className="dark:hidden w-full h-full"
                />
                <img
                  src={`${activeQuestion !== index ? "/icons/processReview/plusDark.svg" : "/icons/processReview/minusDark.svg"}`}
                  alt="plus&minus"
